        ...
        for (const part of parts) {
          if (part.startsWith("data: ")) {
            try {
              ...
              setMessages((msgs) => [
                ...msgs,
                { role: data.model === "A" ? "assistant" : "user", content: data.text },
              ]);
            } catch {}
          }
        }
    ...
    <div className="flex flex-col h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-700">
      ...
      <header className="py-4 px-6 bg-gray-950 shadow-lg flex items-center justify-between">
        <div className="flex items-center gap-2">
          <img src="https://cdn.jsdelivr.net/gh/twitter/twemoji@latest/assets/svg/1f916.svg" alt="Bot" className="w-8 h-8" />
              ...
              >
                {msg.role === "assistant" && (
                  <span className="absolute -left-10 top-1/2 -translate-y-1/2">
                    <img src="https://cdn.jsdelivr.net/gh/twitter/twemoji@latest/assets/svg/1f916.svg" alt="Bot" className="w-6 h-6" />
                  </span>
                )}
                {msg.content}
              </div>
